    ...
    <div class="container">
        <div class="de-margin">
            ...
            <div id="introduce" class="groupBox">
                <div class="textcenter col-sm-6 col-lg-3 p1">
                    <div class="picmove">
                        <a href="assets/images/g1.jpg" data-lightbox="spa-chocolate1">
                        ...
                        <div class="text-section2">
                            ...
                            <h2 class="smalltext"><br>針對個人不同的需求深層保養，以專業保養品搭配獨特手技，滋潤肌底，提高肌膚保濕含水度、使臉部肌膚更加透亮水嫩。 </h2>
                        </div>

                    </div>
                </div>

                <div class="textcenter col-sm-6 col-lg-3 p2">
                    <div class="picmove">
                        <a href="assets/images/g2.jpg" data-lightbox="spa-chocolate2">
                ...
                <div class="textcenter col-sm-6 col-lg-3 p3">
                    <div class="picmove">
                        <a href="assets/images/g3.jpg" data-lightbox="spa-chocolate3">
                ...
                <div class="textcenter col-sm-6 col-lg-3 p4">
                    <div class="picmove">
                        <a href="assets/images/g4.jpg" data-lightbox="spa-chocolate4">
